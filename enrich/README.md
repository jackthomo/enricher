...
If LangGraph Dev is giving you trouble, you can run the graph behind a local FastAPI server instead:

1. Install deps and load your `.env`: `pip install -e .`
2. Start the server: `uvicorn enrichment_agent.api:app --host 0.0.0.0 --port 8000 --reload`
3. Call the endpoint:
